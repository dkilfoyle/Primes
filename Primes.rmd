...
For x>2 the fourth term is a constant 0.1400101011432869
The third term is a constant 0.69314718055994
...
> TODO: Calculate the integral term from x to infinity
...
while (curterm >=2) {
  ...
  if (mudivn != 0) {
    ...
    Log2 = log(2) * mudivn * -1
    Integral = maxIntegral * mudivn #TODO - calculate the actual integral from x to infinity
